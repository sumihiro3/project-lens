...
- **横断サマリー**: 未完了・期限超過・停滞・自分担当の要対応件数とAIリスク分布を統計テーブルに表示。注目上位N件からAI narrative（見出し1行 + 注目点）を自動生成
...
- **横断サマリー**タブ: 全プロジェクト横断で未完了・期限超過・停滞・自分担当件数とAIリスク分布を表示。注目課題のAI narrative（見出し + ポイント）も確認できる
